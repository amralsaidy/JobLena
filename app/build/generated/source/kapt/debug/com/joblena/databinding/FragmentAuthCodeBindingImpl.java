...
public class FragmentAuthCodeBindingImpl extends FragmentAuthCodeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView_subtitle_code_auth, 1);
        sViewsWithIds.put(R.id.otpEditText, 2);
        sViewsWithIds.put(R.id.verify_progress, 3);
        sViewsWithIds.put(R.id.textViewTicker, 4);
    }
    // views
    @NonNull
    ...
    private FragmentAuthCodeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.joblena.presentation.custom.OtpEditText) bindings[2]
