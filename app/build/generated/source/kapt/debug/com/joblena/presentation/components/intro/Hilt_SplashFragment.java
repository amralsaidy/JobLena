...
public abstract class Hilt_SplashFragment<DB extends ViewDataBinding, VM extends ViewModel> extends BaseFragment<DB, VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplashFragment(int layout) {
    super(layout);
  }
