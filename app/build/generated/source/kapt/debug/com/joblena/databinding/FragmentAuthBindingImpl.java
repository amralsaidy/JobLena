...
public class FragmentAuthBindingImpl extends FragmentAuthBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView_title_phone_auth, 1);
        sViewsWithIds.put(R.id.textView_subtitle_phone_auth, 2);
        sViewsWithIds.put(R.id.textField, 3);
        sViewsWithIds.put(R.id.autoCompleteTextView_code, 4);
        sViewsWithIds.put(R.id.textInputLayoutPhone, 5);
        sViewsWithIds.put(R.id.textInputEditText_phone, 6);
        sViewsWithIds.put(R.id.button_verify_phone, 7);
    }
    // views
    @NonNull
