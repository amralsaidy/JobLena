...
public abstract class Hilt_AuthCodeFragment<DB extends ViewDataBinding, VM extends ViewModel> extends BaseFragment<DB, VM> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AuthCodeFragment(int layout) {
    super(layout);
  }
  ...
  protected void inject() {
    ((AuthCodeFragment_GeneratedInjector) this.generatedComponent()).injectAuthCodeFragment(UnsafeCasts.<AuthCodeFragment>unsafeCast(this));
  }
